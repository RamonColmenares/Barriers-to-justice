...
<main class="page-content">
  ...
  <section class="relative bg-gradient-to-br from-[var(--color-primary)] via-[var(--color-accent)] to-[var(--color-secondary)] text-white py-20">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="text-center">
        <h1 class="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl mb-6">Our Team</h1>
        <p class="text-xl leading-8 text-white/90 max-w-3xl mx-auto">
          Meet the researchers and collaborators working to understand barriers to justice in the U.S. immigration system
        </p>
      </div>
    </div>
  </section>
  ...
  <section class="py-16 bg-white">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      ...
      <div class="grid md:grid-cols-3 lg:grid-cols-4 gap-8 max-w-6xl mx-auto mb-16">
        <!-- Ammar Osman -->
      ...
      <div class="bg-gradient-to-br from-[var(--color-primary)] to-[var(--color-accent)] rounded-2xl shadow-lg overflow-hidden text-white max-w-2xl mx-auto">
        <div class="p-8 text-center">
          ...
          <p class="text-white/90 font-medium mb-4">Program Support & Guidance</p>
  ...
  <section class="py-16 bg-white">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="text-center mb-16">
        <h2 class="text-3xl font-bold tracking-tight text-[var(--color-primary)] sm:text-4xl mb-4">Our Values</h2>
        <p class="text-lg text-[var(--color-text-secondary)] max-w-3xl mx-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <div class="text-center">
          ...
          <h3 class="text-lg font-bold text-[var(--color-primary)] mb-2">Transparency</h3>
          <p class="text-[var(--color-text-secondary)] text-sm">
            Open methodology, reproducible analysis, and accessible findings
          </p>
        </div>
        ...
        <div class="text-center">
          ...
          <h3 class="text-lg font-bold text-[var(--color-primary)] mb-2">Collaboration</h3>
          <p class="text-[var(--color-text-secondary)] text-sm">
            Cross-disciplinary partnerships and inclusive research practices
          </p>
        </div>
        ...
        <div class="text-center">
          ...
          <h3 class="text-lg font-bold text-[var(--color-primary)] mb-2">Excellence</h3>
          <p class="text-[var(--color-text-secondary)] text-sm">
            Rigorous methodology and high-quality research standards
          </p>
        </div>
        ...
        <div class="text-center">
          ...
          <h3 class="text-lg font-bold text-[var(--color-primary)] mb-2">Impact</h3>
          <p class="text-[var(--color-text-secondary)] text-sm">
            Research that informs policy and drives positive social change
          </p>
        </div>
      </div>
    </div>
